document.getElementById("id_data_emissao").type = "date"
document.getElementById("id_data_emissao").value = "data de emissão"
document.getElementById("id_titulo").style.marginBottom = "10px"
