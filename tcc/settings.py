...
SECRET_KEY = 'django-insecure-4zkh!o0h87_rk(s(iv%s1vx=t-f(mr%1f1sy(!sonlhg=(fb(o'
...
# Ajuste de configurações de tags mensagens
...
# Configurações para arquivos dinâmicos
